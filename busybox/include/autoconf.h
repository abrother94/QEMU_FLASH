 ...
 */
#define AUTOCONF_TIMESTAMP "2018-11-06 08:14:57 UTC"
...
#define USE_DEBUG(...) __VA_ARGS__
#define SKIP_DEBUG(...)
#define CONFIG_DEBUG_PESSIMIZE 1
#define ENABLE_DEBUG_PESSIMIZE 1
#define USE_DEBUG_PESSIMIZE(...) __VA_ARGS__
#define SKIP_DEBUG_PESSIMIZE(...)
#undef CONFIG_WERROR
...
#define USE_FEATURE_IP_RARE_PROTOCOLS(...) __VA_ARGS__
#define SKIP_FEATURE_IP_RARE_PROTOCOLS(...)
...
#define ENABLE_DEBUG_TFTP 1
#define USE_DEBUG_TFTP(...) __VA_ARGS__
#define SKIP_DEBUG_TFTP(...)
